...
<?php
        ...
        if(isset($_POST['delid'])){
            ...
            echo $_POST['delid'] ;
            echo "</br> </br> ";
            "DELETE FROM  `order_products` WHERE `order_products`.`id` = $suppid";
            "DELETE FROM  `order_products` WHERE `id` = $suppid";
        } 
    		...
    		<div class="element1">
    			<table>
                    ...
                    <tr>
                        ...
                        <div id="hide"> 
                            <input type="text" name="delid" value="4"/>  <!-- <?php echo $product_id ?> -->
                        </div>
